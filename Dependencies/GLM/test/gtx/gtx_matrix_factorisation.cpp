...
int test_qr(glm::mat<C, R, T, Q> m)
{
	...
	//AtlasTextureTest if q*r really equals the input matrix
	...
	//AtlasTextureTest if the columns of q are orthonormal
	...
	//AtlasTextureTest if the matrix r is upper triangular
	for (glm::length_t i = 0; i < C; i++)
...
int test_rq(glm::mat<C, R, T, Q> m)
{
	...
	//AtlasTextureTest if the rows of q are orthonormal
